...
There will be an assignment due before next class, which is to use your newfound reading skills and read Chapter 2 of the Saylor text on Redesigning a Business Process. Like we have just done, I want you to identify 10 terms, determine if they are features or concepts (or both, neither), and briefly describe them. This time, you will upload each individually on this Google Form.
